...
$(function () {
    $(document).on("click", ".remove-image", function (e) {
        ...
        let sportId = parseInt($(this).parent().parent().parent().parent().attr("data-product-id"))
        $.ajax({
            url: `../DeleteImage?id=${id}&sportId=${sportId}`,
            type: 'POST',
    ...
    $(document).on("click", ".make-main", function (e) {
        ...
        $.ajax({
            url: `../ChangeMainImage?id=${id}&sportId=${sportId}`,
            type: 'POST',
            success: function (response) {
