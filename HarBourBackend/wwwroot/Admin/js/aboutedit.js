$(function () {
    $(document).on("click", ".remove-image", function (e) {
        ...
        let aboutId = parseInt($(this).parent().parent().parent().parent().attr("data-product-id"))
        $.ajax({
            url: `../DeleteImage?id=${id}&aboutId=${aboutId}`,
            type: 'POST',
    ...
    $(document).on("click", ".make-main", function (e) {
        ...
        $.ajax({
            url: `../ChangeMainImage?id=${id}&aboutId=${aboutId}`,
            type: 'POST',
            success: function (response) {
